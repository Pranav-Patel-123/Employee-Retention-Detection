    ...
    column(12, align = "center",
           div(class = "form-container",
               ...
               div(class = "form-section",
                   ...
                   numericInput("Age", "Age", value = 30, min = 18, max = 65, attributes = list(class = "form-control")),
                   selectInput("Gender", "Gender", choices = c("Male", "Female"), class = "form-control"),
                   selectInput("MaritalStatus", "Marital Status", choices = c("Single", "Married", "Divorced"), class = "form-control")
               ),
               # Job Related Inputs
               div(class = "form-section",
                   tags$label(class = "form-label", "Job Related"),
                   selectInput("Department", "Department", choices = c("Research & Development", "Sales", "Human Resources"), class = "form-control"),
                   selectInput("JobRole", "Job Role", choices = c("Sales Executive", "Research Scientist", "Laboratory Technician", "Manufacturing Director", "Healthcare Representative", "Manager", "Sales Representative", "Research Director", "Human Resources"), class = "form-control"),
                   numericInput("JobLevel", "Job Level", value = 1, min = 1, max = 5, attributes = list(class = "form-control"))
               ),
               # Work Environment Inputs
               div(class = "form-section",
                   tags$label(class = "form-label", "Work Environment"),
                   selectInput("BusinessTravel", "Business Travel", choices = c("Non-Travel", "Travel_Rarely", "Travel_Frequently"), class = "form-control"),
                   selectInput("OverTime", "Over Time", choices = c("Yes", "No"), class = "form-control"),
                   numericInput("DistanceFromHome", "Distance From Home (miles)", value = 1, min = 1, max = 30, attributes = list(class = "form-control")),
                   numericInput("DailyRate", "Daily Rate ($)", value = 500, min = 0, attributes = list(class = "form-control")),
                   numericInput("HourlyRate", "Hourly Rate ($)", value = 60, min = 0, attributes = list(class = "form-control"))
               ),
               # Performance Inputs
               div(class = "form-section",
                   tags$label(class = "form-label", "Performance"),
                   numericInput("PercentSalaryHike", "Percent Salary Hike (%)", value = 10, min = 0, max = 25, attributes = list(class = "form-control")),
                   numericInput("PerformanceRating", "Performance Rating", value = 3, min = 1, max = 5, attributes = list(class = "form-control"))
               ),
               # Work-life Balance Inputs
               div(class = "form-section",
                   tags$label(class = "form-label", "Work-life Balance"),
                   numericInput("TotalWorkingYears", "Total Working Years", value = 10, min = 0, max = 50, attributes = list(class = "form-control")),
                   numericInput("YearsAtCompany", "Years At Company", value = 5, min = 0, max = 30, attributes = list(class = "form-control")),
                   numericInput("YearsInCurrentRole", "Years In Current Role", value = 3, min = 0, max = 20, attributes = list(class = "form-control")),
                   numericInput("YearsSinceLastPromotion", "Years Since Last Promotion", value = 1, min = 0, max = 15, attributes = list(class = "form-control")),
                   numericInput("YearsWithCurrManager", "Years With Current Manager", value = 2, min = 0, max = 20, attributes = list(class = "form-control")),
                   numericInput("TrainingTimesLastYear", "Training Times Last Year", value = 2, min = 0, max = 10, attributes = list(class = "form-control"))
               ),
               # Submit Button
