...
# Normalize values for all numeric columns
...
# Perform feature selection based on correlation with new cutoff value
correlated_features <- findCorrelation(cor_matrix, cutoff = 0.5)  # Change the cutoff value here
