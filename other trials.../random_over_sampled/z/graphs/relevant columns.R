...
# Set thresholds for feature importance
threshold_accuracy <- 5  # Adjust as needed
threshold_gini <- 5      # Adjust as needed

# Filter features with importance scores above the threshold for MeanDecreaseAccuracy
highly_relevant_features_accuracy <- rownames(importance)[importance[, "MeanDecreaseAccuracy"] > threshold_accuracy]

# Filter features with importance scores above the threshold for MeanDecreaseGini
highly_relevant_features_gini <- rownames(importance)[importance[, "MeanDecreaseGini"] > threshold_gini]

# Print highly relevant feature names based on MeanDecreaseAccuracy
print("Highly Relevant Features based on MeanDecreaseAccuracy:")
print(highly_relevant_features_accuracy)

# Print highly relevant feature names based on MeanDecreaseGini
print("Highly Relevant Features based on MeanDecreaseGini:")
print(highly_relevant_features_gini)
