...
# Suppress chi-square test warnings
suppressWarnings({
...
split <- suppressWarnings(sample.split(data$Attrition, SplitRatio = 0.75))
...
svm_model <- svm(
  ...
  cost = 0.5                 # Alternative: Experiment with different cost values (e.g., 0.1, 1, 10)
)
